...
class GameScheduleRemoteDataSource @Inject constructor(
    ...
    /**
     * Fetches the game schedule from the remote API.
     *
     * @return A [Result] containing either the [ScheduleEntity] or an [MError].
     */
    suspend fun getGameSchedule(): Result<ScheduleWithRelations, MError> {
